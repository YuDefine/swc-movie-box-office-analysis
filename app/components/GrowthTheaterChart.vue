  ...
  <UCard class="transition-shadow duration-200 hover:shadow-lg">
    ...
    <template #footer>
      <div class="space-y-2 text-xs">
        <div
          class="flex items-start gap-2 p-2.5 rounded-lg bg-violet-50 dark:bg-violet-900/20 border border-violet-200/50 dark:border-violet-700/30"
        >
          <UIcon name="i-lucide-zap" class="text-violet-500 flex-shrink-0 mt-0.5" />
          <span class="text-violet-700 dark:text-violet-300"
            >第 4 週戲院從 2 家擴展至 88 家，帶動 1473% 爆發性增長</span
          >
        </div>
        <div
          class="flex items-start gap-2 p-2.5 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200/50 dark:border-emerald-700/30"
        >
          <UIcon name="i-lucide-sparkles" class="text-emerald-500 flex-shrink-0 mt-0.5" />
          <span class="text-emerald-700 dark:text-emerald-300"
            >第 7-8 週維持 88-89 家戲院，票房仍有 125-281% 成長，顯示口碑效應</span
          >
        </div>
      </div>
    </template>
